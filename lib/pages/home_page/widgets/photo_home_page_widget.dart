  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MainLogRegBloc, LogRegBlocStates>(
        builder: (context, state) => AnimatedContainer(
            ...
            margin:
                tap ? EdgeInsets.all(5) : EdgeInsets.only(left: 3, right: 3),
              ...
              Container(
                  ...
                  child: Row(
                      ...
                      children: [
                        ...
                        AnimatedHearContainer(
                            photoModel: widget.photoModel,
                            onTap: () {
                              if (state is LogRegBlocRegisteredState) {
                                ...
                                widget.persistentNavController.jumpToTab(3);
                              }
                            })
                      ]))
            ])));
